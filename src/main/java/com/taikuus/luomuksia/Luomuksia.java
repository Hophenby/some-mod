...
import com.taikuus.luomuksia.setup.*;
import com.taikuus.luomuksia.setup.client.CreativeTab;
...
@Mod(Luomuksia.MODID)
public class Luomuksia
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "luomuksia";
    ...
    public Luomuksia(IEventBus modEventBus, ModContainer modContainer)
    {
    ...
    public void registerEvents(RegisterEvent event){
        event.register(Registries.ITEM, ItemsAndBlocksRegistry::onItemRegistry);
    }
