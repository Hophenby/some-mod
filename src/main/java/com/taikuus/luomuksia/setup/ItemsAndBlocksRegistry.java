...
public class ItemsAndBlocksRegistry {
    ...
    public static final ItemRegistryWrapper<Wand> WAND = new ItemRegistryWrapper<>(ITEM_REGISTRAR.register("wand", Wand::new));

    public static final BlockRegistryWrapper<WandEditingTableBlock> WAND_EDITING_TABLE = new BlockRegistryWrapper<>(
            BLOCK_REGISTRAR.register("wand_editing_table", () -> new WandEditingTableBlock(Block.Properties.ofFullCopy(Blocks.ENCHANTING_TABLE)))
    );
