...
public record TransferFXPacket(Vector3f fromPos, Vector3f toPos, int relayTicks, int color) implements CustomPacketPayload {
    public static final CustomPacketPayload.Type<TransferFXPacket> TYPE = new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath(Luomuksia.MODID, "transfer_fx"));
    @Override
